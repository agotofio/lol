...
<div class="cursor-pointer bg-black neon-box rounded-xl p-6 text-center" onclick="openModal('Алмазы')">
...
<div class="cursor-pointer bg-black neon-box rounded-xl p-6 text-center" onclick="openModal('Ваучеры')">
<h2 class="text-2xl neon-text mb-2">🎫 Ваучеры</h2>
<p class="mb-4">Элитный пропуск и скины</p>
<button class="shop-btn px-6 py-2 rounded">Купить</button>
</div>
<div class="cursor-pointer bg-black neon-box rounded-xl p-6 text-center" onclick="openModal('Прокачка')">
